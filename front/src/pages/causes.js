      ...
      <Motion>
        ...
        <div className="causes-page">
          ...
          <section className="hero-section">
            <div className="hero-text">
              ...
              <p>
                ...
                effort and unwavering hope, we are dedicated to transforming
                lives and building brighter futures.
              </p>
            </div>
          ...
          <section className="mission-section">
            <div className="mission-text">
              ...
              <p>
                ...
                resources to vulnerable communities, and foster opportunities
                for personal and communal growth. We work tirelessly to bridge
                gaps in education, health, and access to essential resources.
              </p>
            </div>
            ...
            <div className="why-it-matters-content">
              <div className="why-text">
                ...
                <p>
                  ...
                  Every drop of support contributes to the sea of impact,
          ...
          <section className="help-section">
            ...
            <p>
              Whether it's through volunteering, donating, or simply spreading
              the word, your support makes a world of difference. Together, we
