          ...
          <div className="about-page">
            ...
            <section className="mission-vision">
              ...
              <div className="mission-content">
                ...
                <p>
                  ...
                  elderly, and disabled individuals with the support and
                  resources they need to lead better lives. Through healthy
                  meals, empowering education, quality healthcare, and adequate
                  shelter, we aim to foster a society that is compassionate and
                  inclusive for all.
                  <br /> <strong>Our Focus Areas:</strong>{" "}
                  <ul>
                    <li>
                      Nourishment: We are committed to feeding the hungry and
                      the impoverished within the community{" "}
                    </li>
                    <li>
                      Education: Empowering individuals with knowledge and
              ...
              <div className="vision-content">
                <p>
                  ...
                  them to become active participants in their communities and
            ...
            <section className="values">
              ...
              <div className="values-list">
                <ul>
                  <li>
                    <strong>Compassion:</strong> We are driven by empathy and
                  ...
                  <li>
                    <strong>Collaboration:</strong> We believe in working
                    together with other organizations to maximize impact.
                  </li>
                  <li>
            ...
            <section className="impact">
              ...
              <div className="impact-content">
                ...
                <p>
                  Over the years, Toto Kalezi Foundation has transformed the
                  lives of many individuals through our various programs. We
                  have provided over 500 children with shelter, 300 individuals
                  with healthcare services, and 200 families with livelihood
                  support. Additionally, we have: <br />
                  <ul>
                    <li>
                  ...
                  thousands, and we remain committed to creating a brighter
                  future for all.
                </p>
              </div>
            </section>
            ...
            <section className="get-involved">
              ...
              <div className="get-involved-content">
                <p>
                  You can make a difference by supporting our foundation.
                  Whether it’s through donations, volunteering, or spreading
                  awareness, every contribution counts.
                </p>
